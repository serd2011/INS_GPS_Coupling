classdef exampleHelperINSGNSS2 < positioning.INSSensorModel
...
%   Copyright 2021 The MathWorks, Inc.
    ...
    methods
        ...
        function obj = exampleHelperINSGNSS2()
            num = 1;
        end
        ...
        function z = measurement(sensor, filt)
            ...
            satPos = sensor.SatellitePosition(sensor.num,:);
            satVel = sensor.SatelliteVelocity(sensor.num,:);
            sensor.num = sensor.num + 1;
            if(sensor.num > 10)
                sensor.num = 1;
            end
            [p, pdot, losVector] ...
        ...
        function dhdx = measurementJacobian(sensor, filt)
            ...
            dhdx(1:numMeas,info.exampleHelperINSGNSS2_ClockBias) = 1;
            dhdx(numMeas+(1:numMeas),info.Velocity) = losVector;
            dhdx(numMeas+(1:numMeas),info.exampleHelperINSGNSS2_ClockDrift) = 1;
        end
    end
